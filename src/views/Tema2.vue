  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.align-items-center.mb-5(data-aos="fade-right")
      .col-lg-10          
        ...
        figure.mb-2
          img(src='@/assets/curso/tema2/img06.png', alt='La figura muestra el paso a paso de la técnica de elaboración de la masa de hojaldre. Texto con la explicación debajo de la figura. 1.	Vuelta simple (o de tres): la masa se estira en un rectángulo alargado y se dobla en tres partes, como si se doblara una carta. Primero se dobla un tercio hacia el centro y luego el otro tercio sobre el primero. 2.	Vuelta doble (o de cuatro): la masa se estira en un rectángulo, se doblan ambos extremos hacia el centro y luego se dobla por la mitad, obteniendo cuatro capas. 3.	Numero de capas: un hojaldre completo suele llevar 6 vueltas simples o 4 vueltas dobles, generando cientos de capas, para una textura excepcional. Con 6 vueltas simples se obtienen teóricamente 729 capas. 4.	Reposo y refrigeración: entre cada vuelta, la masa debe reposar refrigerada mínimo 30 minutos para relajar el gluten y mantener la mantequilla fría.').mx-auto
        figcaption 
          b Nota. 
          | SENA, (2026).
